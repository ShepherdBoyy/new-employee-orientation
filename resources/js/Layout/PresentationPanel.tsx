...
export default function PresentationPanel() {
    ...
    return (
        <>
            ...
            <EditModuleDialog module={module} open={openEditDialog} onOpenChange={setOpenEditDialog}/>
            <DeleteModuleDialog module={module} open={openDeleteDialog} onOpenChange={setOpenDeleteDialog}/>
        </>
    );
}
