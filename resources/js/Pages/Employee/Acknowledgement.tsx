                            ...
                            <div className="animate-in fade-in slide-in-from-right-2 space-y-5 duration-300">
                                ...
                                <div className="space-y-1.5">
                                    <div>
                                        ...
                                        <p className="mt-0.5 text-xs text-muted-foreground">
                                            Draw your signature below using your
                                            mouse or touchscreen.
                                        </p>
                                    </div>
                                    <SignaturePad
                                        onChange={(val) =>
                                            setData("signature", val ?? "")
                                        }
                                    />
                                    {errors.signature && (
                                        <p className="text-sm text-destructive">
                            ...
                            <div className="animate-in fade-in slide-in-from-right-2 space-y-5 duration-300">
                                ...
                                >
                                    ...
                                    <span className="text-xs font-normal leading-relaxed text-muted-foreground">
                                        ...
                                        and agree to comply with all materials
                                        presented in this orientation. I consent
                                        to my electronic signature and photo
                                        being securely stored as part of my
                                        official orientation record, in
