...
import { Pencil, Trash2, EllipsisVertical, Layers3 } from "lucide-react";
    ...
    if (!topics || topics.length === 0) {
        return (
            <motion.div
                ...
                className="flex min-h-56 flex-col items-center justify-center rounded-xl border border-dashed bg-muted/20 p-8 text-center"
            >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl border bg-background shadow-sm p-2">
                    <svg
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2">
                {topics.map((item, index) => (
                    ...
                    >
                        <div
                            className="
                            relative h-full overflow-hidden rounded-xl border border-border/60 bg-card transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 "
                        >
